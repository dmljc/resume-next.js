                    ...
                    {education.map(e => (
                        ...
                        >
                            <CardHeader className="grid grid-cols-[1fr,auto] items-start gap-x-3 pb-4">
                                <CardTitle className="text-xl font-semibold text-gray-900 dark:text-white col-start-1 col-end-2">
                                    {e.school[lang]}
                                </CardTitle>
                                <span className="text-sm sm:text-base text-gray-500 dark:text-gray-500 whitespace-nowrap justify-self-end col-start-2 col-end-3">
                                    {e.time[lang]}
                                </span>
                                <CardDescription className="mt-1 text-base sm:text-lg text-gray-600 dark:text-gray-300 col-span-2 w-full block">
                                    {e.degree[lang]}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <p className="text-sm sm:text-base leading-relaxed sm:leading-7 break-words text-gray-600 dark:text-gray-300">
                                    {e.desc[lang]}
                                </p>
                            </CardContent>
                        </Card>
