            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 sm:mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {skills.map(s => (
                        ...
                        >
                            <CardHeader>
                                <CardTitle className="text-lg sm:text-xl font-semibold mb-4 text-gray-900 dark:text-white">
                                    {t(s.titleKey)}
                                </CardTitle>
                                <CardDescription className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4">
                                    {t(s.descKey)}
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="flex flex-wrap gap-2">
                                {s.tags.map(tag => {
                                    ...
                                    return (
                                        <Badge key={key} className={tagClass(label)}>
                                            {label}
                                        </Badge>
                                    );
                                })}
