                                    ...
                                    {skills.map(s => (
                                        <div key={s.titleKey} className="mb-4">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {s.tags.map(tag => {
                                                    const label =
                                                        typeof tag === 'string' ? tag : tag[lang];
                                                    const key =
                                                        typeof tag === 'string' ? tag : tag.zh;
                                                    return (
                                                        <Badge
                                                            key={key}
                                                            variant="plain"
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2">
                                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                            {t('advantages.label.experience')}
                                        </h3>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            {t('advantages.value.experience')}
                                        </p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                            {t('advantages.label.stack')}
                                        </h3>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            {t('advantages.value.stack')}
                                        </p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                            {t('advantages.label.focus')}
                                        </h3>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            {t('advantages.value.focus')}
                                        </p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                            {t('advantages.label.highlights')}
                                        </h3>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            {t('advantages.value.highlights')}
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
